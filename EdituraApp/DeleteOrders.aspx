<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteOrders.aspx.cs" Inherits="EdituraWeb.DeleteOrders" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Anulare comenzi • Admin</title>
    ...
    <div class="container mt-4 mb-5">
            ...
            <div class="row g-0">
                <div class="col-lg-5 hero-left">
                    <div class="hero-content">
                        ...
                        <h2 class="mt-3 fw-bold mb-1">Anulare comenzi</h2>
                        <div class="opacity-90">
                            Șterge o comandă și restochează automat cărțile asociate.
                        </div>
                ...
                <div class="col-lg-7 bg-white">
                    <div class="p-4 p-lg-5">
                        <h4 class="fw-bold mb-1">Ștergere comenzi</h4>
                        <div class="muted mb-3">
                            Selectează o comandă și apasă Delete. Sistemul va face restocarea automat.
                        </div>
                        ...
                        <div class="d-flex flex-wrap gap-2 mt-3">
                            ...
                            <asp:Label ID="lblCount" runat="server" CssClass="muted align-self-center"></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow-sm p-4 cardx bg-white">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h5 class="m-0 fw-bold"><i class="bi bi-table"></i> Lista comenzilor</h5>
            ...
            <asp:GridView ID="gvOrders" runat="server"
                ...
                EmptyDataText="Nu exista comenzi.">

                <Columns>
                    <asp:BoundField DataField="id_comanda" HeaderText="ID Comandă" />
                    <asp:BoundField DataField="client" HeaderText="Client" />
                    <asp:BoundField DataField="data_comanda" HeaderText="Data" DataFormatString="{0:yyyy-MM-dd}" />
                    <asp:BoundField DataField="total" HeaderText="Total (lei)" DataFormatString="{0:N2}" />
            ...
            <div class="d-flex flex-wrap gap-2 mt-3">
                <asp:Button ID="btnDelete" runat="server"
                    Text="Anulează comanda (restocare)"
                    CssClass="btn btn-danger btn-pill"
                    Enabled="false"
                    OnClientClick="return confirm('Sigur vrei să anulezi această comandă? Stocurile vor fi restocate.');"
